...
} from "./chunk-W6CZRY3F.js";
import {
  init_styled,
  styled_default
} from "./chunk-KQSF2VNJ.js";
import {
...
function BreadcrumbCollapsed(props) {
  const {
    slots = {},
    slotProps = {}
  } = props, otherProps = _objectWithoutPropertiesLoose(props, _excluded4);
  const ownerState = props;
  return (0, import_jsx_runtime7.jsx)("li", {
    children: (0, import_jsx_runtime7.jsx)(BreadcrumbCollapsedButton, _extends({
      focusRipple: true
    }, otherProps, {
      ownerState,
      children: (0, import_jsx_runtime7.jsx)(BreadcrumbCollapsedIcon, _extends({
...
var _excluded5 = ["children", "className", "component", "slots", "slotProps", "expandText", "itemsAfterCollapse", "itemsBeforeCollapse", "maxItems", "separator"];
...
function insertSeparators(items, className, separator, ownerState) {
  return items.reduce((acc, current, index) => {
    if (index < items.length - 1) {
      acc = acc.concat(current, (0, import_jsx_runtime8.jsx)(BreadcrumbsSeparator, {
        "aria-hidden": true,
        className,
        ownerState,
        children: separator
...
var Breadcrumbs = React15.forwardRef(function Breadcrumbs2(inProps, ref) {
  ...
  const renderItemsBeforeAndAfter = (allItems2) => {
    ...
    return [...allItems2.slice(0, itemsBeforeCollapse), (0, import_jsx_runtime8.jsx)(BreadcrumbCollapsed_default, {
  ...
  }).map((child, index) => (0, import_jsx_runtime8.jsx)("li", {
    className: classes.li,
    children: child
  }, `child-${index}`));
  return (0, import_jsx_runtime8.jsx)(BreadcrumbsRoot, _extends({
    ref,
    component,
    ...
    children: (0, import_jsx_runtime8.jsx)(BreadcrumbsOl, {
...
//# sourceMappingURL=chunk-KY4Z7GKV.js.map
