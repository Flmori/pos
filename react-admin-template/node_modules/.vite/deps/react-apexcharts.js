  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var tt = function() {
      ...
      return r(t2, [{ key: "init", value: function() {
        ...
        var e2 = t3.theme.mode, i2 = "dark" === e2 ? "#424242" : "light" === e2 ? "#fff" : t3.chart.background || "#fff", a2 = "dark" === e2 ? "palette4" : "light" === e2 ? "palette1" : t3.theme.palette || "palette1", s2 = "dark" === e2 ? "#f6f7f8" : "light" === e2 ? "#373d3f" : t3.chart.foreColor || "#373d3f";
        return t3.tooltip.theme = e2 || "light", t3.chart.foreColor = s2, t3.chart.background = i2, t3.theme.palette = a2, t3;
    ...
    var ot = function() {
      ...
      return r(t2, [{ key: "plotCoords", value: function() {
        ...
        if (!i2.legend.show || i2.legend.floating) return e2.gridHeight = e2.svgHeight - i2.grid.padding.left + i2.grid.padding.right, e2.gridWidth = Math.min(e2.svgWidth, e2.gridHeight), e2.translateY = r2, void (e2.translateX = o2 + (e2.svgWidth - e2.gridWidth) / 2);
